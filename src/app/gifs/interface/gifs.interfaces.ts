// To parse this data:
//
//   import { Convert, BusquedaGifs } from "./file";
//
//   const busquedaGifs = Convert.toBusquedaGifs(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface BusquedaGifs {
    data:       Gif[];
...
export enum SourceTLD {
    ...
    WWWMemecenterCOM = "www.memecenter.com",
}
...
export class Convert {
    public static toBusquedaGifs(json: string): BusquedaGifs {
        return cast(JSON.parse(json), r("BusquedaGifs"));
    }

    public static busquedaGifsToJson(value: BusquedaGifs): string {
        return JSON.stringify(uncast(value, r("BusquedaGifs")), null, 2);
    }
}
